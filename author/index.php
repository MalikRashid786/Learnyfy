        ...
        <div class="row align-items-center justify-content-xl-between">
          <div class="col-xl-6">
            <div class="copyright text-center text-xl-left text-muted">
              © 2020 This Website Made By <a href="../about.php" class="font-weight-bold ml-1" target="_blank">Er. Md Rashid</a>
            </div>
          </div>
          <div class="col-xl-6">
            <ul class="nav nav-footer justify-content-center justify-content-xl-end">
              ...
              <li class="nav-item">
                <a href="https://www.instagram.com/rashidmalik_78692/" class="nav-link" target="_blank"><i class="fa fa-instagram"></i></a>
              </li>
            </ul>
          </div>
        </div>
