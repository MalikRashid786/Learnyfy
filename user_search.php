            ...
            <div class="col-lg-4 sidebar-widgets">
              <div class="widget-wrap">
                ...
                <div class="single-sidebar-widget user-info-widget">
                  <img style="padding: 6px;background: #fff;height: 120px" src="img/53.jpg" class="rounded-circle shadow" alt=""><h4 class="mt-3">Er. Md Rashid</h4>
                  <p>
                    Junior blog writer
                  </p>
                  <ul class="social-links">
                    ...
                    <li><a target="_blank" href="https://www.instagram.com/rashidmalik_78692/"><i class="fa fa-instagram"></i></a></li>
                  </ul>
                  <p>
                    Hey everyone, I’m RASHID and am thrilled to have you visiting my blog.I live in LUCKNOW with my family. I started this blog on a whim in the fall of 2020. I was frequently asked for my article from friends and family members. I happened to follow a few article blogs and one day I thought ” Hey, why not start my own?” So here is the result. My blog is constantly changing and growing as I learn more about blogging. It truly is an art. I hope you enjoy the blog as much as I enjoy creating it.
                  </p>
                </div>
