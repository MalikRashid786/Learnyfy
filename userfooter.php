                    ...
                    <div class="row justify-content-center text-center">
                        <div class="col-lg-5 col-md-5 col-sm-5">
                            <div class="single-footer-widget">
                                ...
                                <p class="footer-text">Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This Website is made  by <a href="user_about.php" target="_blank">Er. Md Rashid</a></p>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-3 social-widget">        
                            ...
                            <div class="single-footer-widget">
                                ...
                                <div class="footer-social justify-content-center" style="margin-left: -10px">
                                    ...
                                    <a target="_blank" href="https://www.instagram.com/rashidmalik_78692/"><i class="fa fa-instagram"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
